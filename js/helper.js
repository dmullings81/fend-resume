...
var HTMLheaderRole = '<br><span class="role">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%data%</span><hr>';
...
var HTMLskillsStart = '<h3 class="skills-h3">Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul><hr>';
...
var HTMLschoolMajor = '<em><br>Subjects: %data%</em>';
